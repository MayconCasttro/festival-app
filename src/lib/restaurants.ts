...
export const RESTAURANTS: Restaurant[] = [
  {
    ...
    i18n: {
      en: {
        ...
        dishName: 'Canoeiro',
        dishDescription: 'Grilled salmon with smashed potatoes, coconut pangrattato and a light moqueca foam.',
      },
      es: {
        description: 'Mariscos con un toque contemporáneo y creativo.',
        dishName: 'Canoeiro',
        dishDescription: 'Salmón a la parrilla con patata desconchada, pangranato de coco y espuma ligera de moqueca.',
      },
      fr: {
        description: "Fruits de mer avec une touche contemporaine et créative.",
        dishName: 'Canoeiro',
        dishDescription: "Saumon grillé avec pommes de terre écrasées, pangranato de noix de coco et une légère mousse de moqueca.",
      },
    },
  },
  {
    ...
    i18n: {
      en: {
        description: 'Modern bar with generous portions and signature cocktails.',
        dishName: 'Maracangalha',
        dishDescription: 'Grilled shrimp over sweet potato mousseline with passion fruit sauce.',
      },
      es: {
        description: 'Bar moderno con buenas raciones y cócteles de autor.',
        dishName: 'Maracangalha',
        dishDescription: 'Camarones a la parrilla sobre muselina de batata dulce con salsa de maracuyá.',
      },
      fr: {
        description: 'Bar moderne avec de bonnes portions et des cocktails signatures.',
        dishName: 'Maracangalha',
        dishDescription: "Crevettes grillées sur mousseline de patate douce avec sauce au fruit de la passion.",
      },
    },
  },
  {
    ...
    i18n: {
      en: {
        ...
        dishName: 'Samba da Minha Terra',
        dishDescription: 'Shrimps in moqueca style with panko crust and catupiry cheese.',
      },
      es: {
        description: 'Sabores mexicanos con un toque costero.',
        dishName: 'Samba da Minha Terra',
        dishDescription: 'Camarones al estilo moqueca con costra de panko y catupiry.',
      },
      fr: {
        description: 'Saveurs mexicaines avec une touche côtière.',
        dishName: 'Samba da Minha Terra',
        dishDescription: 'Crevettes à la mode moqueca avec croûte de panko et catupiry.',
      },
    },
  },
  {
    ...
    i18n: {
      en: {
        ...
        dishName: 'Sabor da Maré',
        dishDescription: 'Grilled fish fillet with seafood rice and cashew farofa.',
      },
      es: {
        description: 'Cocina casera con ingredientes frescos y sabrosos.',
        dishName: 'Sabor da Maré',
        dishDescription: 'Filete de pescado a la parrilla con arroz de mariscos y farofa de anacardo.',
      },
      fr: {
        description: 'Cuisine maison avec des ingrédients frais et savoureux.',
        dishName: 'Sabor da Maré',
        dishDescription: 'Filet de poisson grillé avec riz aux fruits de mer et farofa de noix de cajou.',
      },
    },
  },
  {
    ...
    i18n: {
      en: {
        ...
        dishName: 'Jangada',
        dishDescription: 'Grilled octopus sandwich with lemon aioli and arugula on artisan bread.',
      },
      es: {
        description: 'Hamburguesas artesanales y platos de mar en el mismo menú.',
        dishName: 'Jangada',
        dishDescription: 'Sándwich de pulpo a la parrilla con alioli de limón y rúcula en pan artesanal.',
      },
      fr: {
        description: 'Burgers artisanaux et plats de la mer dans le même menu.',
        dishName: 'Jangada',
        dishDescription: 'Sandwich de poulpe grillé avec aïoli au citron et roquette sur pain artisanal.',
      },
    },
  },
  {
    ...
    i18n: {
      en: {
        ...
        dishDescription: 'Pizza with salmon and passion fruit sauce, cream cheese and mozzarella.',
      },
      es: {
        description: 'Pizza napolitana con ingredientes regionales.',
        dishName: 'Pizza Encanto del Litoral',
        dishDescription: 'Pizza con salmón y salsa de maracuyá, queso crema y mozzarella.',
      },
      fr: {
        description: 'Pizza napolitaine avec des ingrédients régionaux.',
        dishName: 'Pizza Enchantement Côtier',
        dishDescription: "Pizza au saumon et sauce au fruit de la passion, cream cheese et mozzarella.",
      },
    },
  },
  {
    ...
    i18n: {
      en: {
        ...
        dishName: 'Lenda do Abaeté',
        dishDescription: 'Caramel cream dessert with coconut milk and coffee caramel.',
      },
      es: {
        description: 'Cafetería y postres con identidad nordestina.',
        dishName: 'Lenda do Abaeté',
        dishDescription: 'Postre de crema de caramelo con leche de coco y caramelo de café.',
      },
      fr: {
        description: 'Café et desserts avec une identité nord-estienne.',
        dishName: 'Lenda do Abaeté',
        dishDescription: 'Dessert crème caramel avec lait de coco et caramel au café.',
      },
    },
  },
  {
    ...
    i18n: {
      ...
      fr: {
        ...
        dishDescription: 'Risotto créatif aux fruits de mer et saveurs côtières.',
      },
    },
  },
  {
    ...
    i18n: {
      en: {
        ...
        dishName: 'Acalanto',
        dishDescription: 'Gambas à Brás with prawns, artisanal shoestring potatoes and fresh herbs.',
      },
      es: {
        description: 'Sabores portugueses con influencia costera.',
        dishName: 'Acalanto',
        dishDescription: 'Gambas à Brás con camarones, patata paja artesanal y hierbas frescas.',
      },
      fr: {
        description: 'Saveurs portugaises avec influence côtière.',
        dishName: 'Acalanto',
        dishDescription: 'Gambas à Brás avec crevettes, pommes paille artisanales et herbes fraîches.',
      },
    },
  },
  {
    ...
    i18n: {
      en: {
        ...
        dishDescription: 'Shrimps in curry sauce with pineapple and roasted vegetables.',
      },
      es: {
        description: 'Churrasquería con opciones de mariscos.',
        dishName: 'Encanto de la Bahía',
        dishDescription: 'Camarones con salsa curry con piña y verduras asadas.',
      },
      fr: {
        description: 'Churrascaria avec des options de fruits de mer.',
        dishName: 'Enchantement de la Baie',
        dishDescription: 'Crevettes en sauce curry avec ananas et légumes rôtis.',
      },
    },
  },
  {
    ...
    i18n: {
      en: {
        ...
        dishDescription: 'Sole fillet with shrimp and pomegranate sauce, served with vegetables.',
      },
      es: {
        description: 'Comida nordestina con toques contemporáneos.',
        dishName: 'Barca del Bosque',
        dishDescription: 'Filete de lenguado con camarones y salsa de granada, acompañado de verduras.',
      },
      fr: {
        description: 'Cuisine nord-est brésilienne avec des touches contemporaines.',
        dishName: 'Barque de la Forêt',
        dishDescription: 'Filet de sole avec crevettes et sauce grenade, accompagné de légumes.',
      },
    },
  },

  {
    ...
    i18n: {
      ...
      es: {
        ...
        dishName: 'Caymmi Sunset',
        dishDescription: 'Poke de camarones marinados con aguacate y cebolla roja.',
      },
      fr: {
        description: 'Poke bowls frais avec poisson et ingrédients locaux.',
        dishName: 'Caymmi Sunset',
        dishDescription: 'Poke de crevettes marinées avec avocat et oignon rouge.',
      },
    },
  },
  {
    ...
    i18n: {
      ...
      fr: {
        ...
        dishDescription: "Plat avec poulpe et fruits de mer inspiré par le littoral.",
      },
    },
  },
  {
    ...
    coords: { lat: -22.443118403894864, lng: -41.8739647609801 },
    i18n: {
      en: {
